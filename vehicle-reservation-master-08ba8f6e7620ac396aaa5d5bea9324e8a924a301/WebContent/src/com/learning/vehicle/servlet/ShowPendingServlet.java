...
/**
 * Servlet implementation class ShowPendingServlet
 */
@WebServlet({ "/ShowPendingServlet", "/ShowPending" })
public class ShowPendingServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowPendingServlet() {
        super();
