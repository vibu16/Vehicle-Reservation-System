...
/**
 * Servlet implementation class CustomerSearchVehicleServlet
 */
@WebServlet({ "/CustomerSearchVehicleServlet", "/CustomerSearchVehicle" })
public class CustomerSearchVehicleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CustomerSearchVehicleServlet() {
		super();
